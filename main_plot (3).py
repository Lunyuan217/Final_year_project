...
Original file is located at
    https://colab.research.google.com/drive/1V7tCDK8es1sufD6DSojNAIZ3z6y4ZlVU
"""
...
s = slice(40,49,1)
for i in np.linspace(10,120,12, endpoint=True):
...
plt.legend()
# Display a figure.
plt.savefig('/content/drive/MyDrive/Final_year_project/Figures/PSNR-views-120.png')
plt.show()